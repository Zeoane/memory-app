(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e={boardSizeId:`4x4`,visualThemeId:`code-vibes`,layoutId:`nature`,firstPlayerColor:`blue`};function t(){return{boardSizeId:null,visualThemeId:null,firstPlayerColor:null}}var n={view:`home`,settings:{...e},settingsDraft:t(),game:null,showGameOver:!1},r=[{id:`4x4`,cols:4,rows:4,label:`16 cards`},{id:`4x6`,cols:4,rows:6,label:`24 cards`},{id:`6x6`,cols:6,rows:6,label:`36 cards`}],i=[{id:`code-vibes`,label:`Code vibes theme`,description:`Teal, klarer Dev-Look`},{id:`gaming`,label:`Gaming theme`,description:`Neon-Kanten, dunkle Karten`},{id:`da-projects`,label:`DA Projects theme`,description:`Sachlich, hoher Kontrast`},{id:`foods`,label:`Foods theme`,description:`Warme Töne, einladend`}],a=[{id:`nature`,label:`Natur & Tiere`,description:`Grüntöne, Wald- und Tier-Motive`,cssClass:`layout-nature`,pairs:`🐻.🦊.🐸.🐼.🦁.🐯.🐵.🐰.🦉.🦋.🐢.🦔.🌲.🌿.🍄.🌻.🦆.🐧.🦩.🐝.🍃.🌳.🌺.🪵.🪨.🦫.🐿️.🦌.🐬.🦭.🪷.🌴`.split(`.`)},{id:`space`,label:`Weltraum`,description:`Dunkelblau/Violett, Kosmos-Motive`,cssClass:`layout-space`,pairs:`🚀.🛸.🛰️.🌙.⭐.🌟.🪐.☄️.🌌.👽.🌑.🌠.🔭.🌍.🌕.☀️.🌎.🌖.🌗.🌘.🌒.🌓.🌔.🌚.👾.🤖.💫.✨.⚡.🌩️.📡.🧑‍🚀`.split(`.`)}];function o(e){return e===`blue`?{player1:`blue`,player2:`orange`}:{player1:`orange`,player2:`blue`}}function s(e){let t=r.find(t=>t.id===e);if(!t)throw Error(`Unbekannte Spielfeldgröße: ${e}`);return t}function c(e){let t=a.find(t=>t.id===e);if(!t)throw Error(`Unbekanntes Layout: ${e}`);return t}function l(e){let t=i.find(t=>t.id===e);if(!t)throw Error(`Unbekanntes Theme: ${e}`);return t}function u(e){return e.cols*e.rows/2}function ee(e){let t=[...e];for(let e=t.length-1;e>0;--e){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function d(e,t){let n=[],r=0;for(let i=0;i<t;i+=1){let t=e[i];n.push({id:r++,pairId:i,symbol:t}),n.push({id:r++,pairId:i,symbol:t})}return n}function f(e){let t=s(e.boardSizeId),n=c(e.layoutId),r=u(t),i=n.pairs.slice(0,r);if(i.length<r)throw Error(`Nicht genügend Symbole für die gewählte Spielfeldgröße.`);return ee(d(i,r))}var p=class{cards;revealed;matched;scores;currentPlayer;firstSelection=null;secondSelection=null;busy=!1;complete=!1;constructor(e){let t=f(e);this.cards=t,this.revealed=t.map(()=>!1),this.matched=t.map(()=>!1),this.scores=[0,0],this.currentPlayer=0}getSnapshot(){return this.createSnapshot()}createSnapshot(){return{cards:this.cards,revealed:this.revealed,matched:this.matched,scores:this.scores,currentPlayer:this.currentPlayer,firstSelection:this.firstSelection,secondSelection:this.secondSelection,isBusy:this.busy,isComplete:this.complete}}isFaceVisible(e){return this.revealed[e]||this.matched[e]}hasPendingSecondPick(){return this.firstSelection!==null&&this.secondSelection!==null}canSelect(e){return this.busy||this.complete||this.matched[e]||this.hasPendingSecondPick()?!1:this.firstSelection!==e}clearSelection(){this.firstSelection=null,this.secondSelection=null}isPairMatch(e,t){return this.cards[e].pairId===this.cards[t].pairId}switchPlayer(){this.currentPlayer=this.currentPlayer===0?1:0}markPairMatched(e,t){this.matched[e]=!0,this.matched[t]=!0,this.scores[this.currentPlayer]+=1}applyMatch(e,t,n,r){this.markPairMatched(e,t),this.clearSelection(),this.busy=!1,this.matched.every(Boolean)&&(this.complete=!0),n(),this.complete&&r()}applyMismatch(e,t,n){this.revealed[e]=!1,this.revealed[t]=!1,this.clearSelection(),this.switchPlayer(),this.busy=!1,n()}resolveFlip(e,t,n,r){this.isPairMatch(e,t)?this.applyMatch(e,t,n,r):this.applyMismatch(e,t,n)}scheduleFlipResolution(e,t,n,r){window.setTimeout(()=>{this.resolveFlip(e,t,n,r)},700)}openSecondPick(e,t,n){this.secondSelection=e,this.busy=!0,t();let r=this.firstSelection,i=this.secondSelection;r===null||i===null||this.scheduleFlipResolution(r,i,t,n)}selectCard(e,t,n){if(this.canSelect(e)){if(this.revealed[e]=!0,this.firstSelection===null){this.firstSelection=e,t();return}this.openSecondPick(e,t,n)}}};function m(e){let[t,n]=e;return t>n?`player1`:n>t?`player2`:`draw`}function h(e,t){return e.querySelector(`input[name="${t}"]:checked`)?.value??null}function g(e){let t=h(e,`boardSize`);t!==null&&(n.settingsDraft.boardSizeId=t)}function te(e){let t=h(e,`playerColor`);t!==null&&(n.settingsDraft.firstPlayerColor=t)}function ne(e){let t=h(e,`visualTheme`);t!==null&&(n.settingsDraft.visualThemeId=t)}function _(e){g(e),te(e),ne(e)}function v(e,t,n){e.querySelectorAll(`[data-action="${t}"]`).forEach(e=>{e.addEventListener(`click`,n)})}function y(e){n.view=`settings`,n.settingsDraft=t(),e()}function b(e){n.view=`home`,e()}function x(t,r){_(t),n.settings={...e,...n.settingsDraft.visualThemeId?{visualThemeId:n.settingsDraft.visualThemeId}:{},...n.settingsDraft.firstPlayerColor?{firstPlayerColor:n.settingsDraft.firstPlayerColor}:{},...n.settingsDraft.boardSizeId?{boardSizeId:n.settingsDraft.boardSizeId}:{}},n.game=new p(n.settings),n.showGameOver=!1,n.view=`game`,r()}function S(e){n.game=null,n.showGameOver=!1,n.view=`settings`,n.settingsDraft=t(),e()}function C(e){n.game=new p(n.settings),n.showGameOver=!1,e()}function w(e,t){let r=e.currentTarget,i=Number(r.dataset.cardIndex),a=n.game;a===null||Number.isNaN(i)||a.selectCard(i,()=>t(),()=>{n.showGameOver=!0,t()})}function T(e,t){e.querySelectorAll(`.memory-card[data-card-index]`).forEach(e=>{e.addEventListener(`click`,e=>w(e,t))})}function E(e,t){let n=e.querySelector(`.screen--settings`);n!==null&&n.querySelectorAll(`input[type="radio"]`).forEach(n=>{n.addEventListener(`change`,()=>{_(e),t()})})}function D(e,t){v(e,`go-settings`,()=>y(t)),v(e,`go-home`,()=>b(t)),v(e,`start-game`,()=>x(e,t)),v(e,`exit-game`,()=>S(t)),v(e,`new-round`,()=>C(t)),v(e,`go-settings-from-game`,()=>S(t)),T(e,t),E(e,t)}var O=`app-root`;function k(e,t,n){if(e.className=``,e.classList.add(O),e.classList.add(`theme--${t.visualThemeId}`),n===`settings`){e.classList.add(`app-root--settings`);return}e.classList.add(c(t.layoutId).cssClass)}var A=0;function j(e,t,n){return`<div class="game-bar__pair">
            <dt class="game-bar__score-label">${e}</dt>
            <dd class="game-bar__score-value"><span class="${n}">${t}</span></dd>
          </div>`}function M(e,t){let n=`score score--p1 player-tag player-tag--${t.player1}`,r=`score score--p2 player-tag player-tag--${t.player2}`;return`<dl class="game-bar__scores">${`${j(`Spieler 1`,e.scores[0],n)}${j(`Spieler 2`,e.scores[1],r)}`}</dl>`}function N(e,t){return e.currentPlayer===A?`player-tag--${t.player1}`:`player-tag--${t.player2}`}function P(e){return e.currentPlayer===A?`Spieler 1`:`Spieler 2`}function F(e,t){return`<p class="game-bar__turn">Am Zug: <strong class="player-tag ${N(e,t)}">${P(e)}</strong></p>`}function I(){return`<nav class="game-bar__nav" aria-label="Spielaktionen">
          <ul class="game-bar__nav-list">
            <li>
              <button type="button" class="btn btn--ghost" data-action="exit-game">Exit Game</button>
            </li>
          </ul>
        </nav>`}function L(e,t){return`${M(e,t)}${F(e,t)}${I()}`}function R(e,t){return e.isBusy||e.isComplete||t?`disabled`:``}function z(e){return`<span class="memory-card__inner">
          ...
          </span>`}function B(e,t,n){let r=e.isFaceVisible(n),i=t.matched[n],a=r?` is-flipped`:``,o=i?` is-matched`:``,s=R(t,i),c=t.cards[n];return`<button type="button" class="memory-card${a}${o}" data-card-index="${n}" aria-label="Karte ${n+1}" ${s}>${z(c.symbol)}</button>`}function V(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}var H=`<dialog class="modal" open aria-labelledby="game-over-title" aria-modal="true">\r
...
`;function U(e,t){let n=e;for(let[e,r]of Object.entries(t))n=n.replaceAll(`{{${e}}}`,r);return n}function W(e,t,n){return`Spieler 1: <span class="player-tag player-tag--${n.player1}">${e}</span> · Spieler 2: <span class="player-tag player-tag--${n.player2}">${t}</span>`}function G(e){return e===`draw`?`Unentschieden!`:e===`player1`?`Spieler 1 gewinnt!`:`Spieler 2 gewinnt!`}function K(e){return e===`draw`?``:` modal__winner--highlight`}function q(e,t,n){let r=m([e,t]),i=G(r);return U(H,{SCORE_LINE:W(e,t,n),WINNER_MODIFIER:K(r),MESSAGE:V(i)})}var J=`<main class="screen screen--game">\r
...
`;function Y(e,t){return`--cols: ${e}; --rows: ${t};`}function X(e,t){return t.cards.map((n,r)=>B(e,t,r)).join(``)}function Z(e,t,n){return t&&e.isComplete?q(e.scores[0],e.scores[1],n):``}function re(e,t,n){let i=e.getSnapshot(),a=o(t.firstPlayerColor),s=r.find(e=>e.id===t.boardSizeId);return s===void 0?``:U(J,{GAME_BAR:L(i,a),GRID_STYLE:Y(s.cols,s.rows),CARDS:X(e,i),GAME_OVER:Z(i,n,a)})}function ie(e,t,n){return e===null?``:re(e,t,n)}var ae=``+new URL(`Primary button-CNXT5xaq.svg`,import.meta.url).href,oe=`<svg class="screen-home__deco-svg" aria-hidden="true" focusable="false" width="363" height="410" viewBox="0 0 363 410" fill="none" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
...
`,se=`<main class="screen screen--home">\r
...
`;function ce(){return U(se,{PRIMARY_BUTTON_SRC:ae,STADIA_CONTROLLER_SVG:oe.trim()})}var le=`<main class="screen screen--settings">\r
...
`,ue=`<section class="panel panel--settings panel--board-size" aria-labelledby="fieldset-board-size-title">
...
`,de=`<section class="panel panel--settings panel--choose-player" aria-labelledby="fieldset-player-color-title">
...
`,fe=`<section class="panel panel--settings panel--game-themes" aria-labelledby="fieldset-visual-theme-title">
...
`,pe=``+new URL(`Code-Vibes_Inner-Topbar-CI3KVVNk.svg`,import.meta.url).href,me=``+new URL(`Code-Vibes-cv-B7taLid1.svg`,import.meta.url).href,he=``+new URL(`Gaming_Theme-topbar-CgP4tIcw.svg`,import.meta.url).href,ge=``+new URL(`Gaming_Theme-ZKFTc52L.svg`,import.meta.url).href,_e=``+new URL(`DA_Projects-topbar-DnEtUlKc.svg`,import.meta.url).href,ve=``+new URL(`DA_Projects-wSZG-MAT.svg`,import.meta.url).href,ye=``+new URL(`Foods-theme-topbar-r1xif0kT.svg`,import.meta.url).href,be=``+new URL(`Foods-theme-mXqqlxmL.svg`,import.meta.url).href,xe=`data:image/svg+xml,%3csvg%20width='263'%20height='24'%20viewBox='0%200%20263%2024'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M-0.000152588%2011.547L11.5469%2023.094L23.0939%2011.547L11.5469%20-8.58307e-06L-0.000152588%2011.547ZM262.547%2011.547V9.547L11.5469%209.547V11.547V13.547L262.547%2013.547V11.547Z'%20fill='%23F0EA6E'/%3e%3c/svg%3e`,Se=`data:image/svg+xml,%3csvg%20width='50'%20height='18'%20viewBox='0%200%2050%2018'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M49.6603%208.66028L41%202.28095e-05L32.3397%208.66028L41%2017.3205L49.6603%208.66028ZM0%208.66028L0%2010.1603L41%2010.1603V8.66028V7.16028L0%207.16028L0%208.66028Z'%20fill='%23F0EA6E'/%3e%3c/svg%3e`;function Ce(e){switch(e){case`code-vibes`:return{topbarUrl:pe,stageUrl:me};case`gaming`:return{topbarUrl:he,stageUrl:ge};case`da-projects`:return{topbarUrl:_e,stageUrl:ve};case`foods`:return{topbarUrl:ye,stageUrl:be}}}function we(e,t){let n=e.boardSizeId===t.id?`checked`:``;return`
      <li>
        <label class="choice choice--board-size">
          <input class="choice__radio choice__radio--theme" type="radio" name="boardSize" value="${t.id}" ${n} />
          <span class="choice__title choice__title--board">${V(t.label)}</span>
        </label>
      </li>
    ...
    `}function Ee(e,t){let n=e.visualThemeId===t.id?`checked`:``;return`
      <li>
        <label class="choice choice--game-theme">
          ...
          <span class="choice__theme-body">
            <span class="choice__title choice__title--theme">${V(t.label)}</span>
            <span class="choice__theme-accent" aria-hidden="true">
              <img class="choice__theme-accent-img" src="${Se}" width="41" height="18" alt="" decoding="async" />
            </span>
          </span>
        </label>
      </li>
    `}function De(e){return U(ue,{RADIOS:r.map(t=>we(e,t)).join(``)})}function Oe(e){return U(de,{RADIOS:[`blue`,`orange`].map(t=>Te(e,t)).join(``)})}function Q(e){return U(fe,{RADIOS:i.map(t=>Ee(e,t)).join(``)})}function ke(e,t){return t.visualThemeId===null?`Game theme`:l(t.visualThemeId).label}function Ae(e,t){return t.firstPlayerColor===null?`Player`:t.firstPlayerColor===`blue`?`Blue`:`Orange`}function je(e,t){return t.boardSizeId===null?`Board size`:s(t.boardSizeId).label}function Me(e,t){let n=t.visualThemeId??e.visualThemeId,r=Ce(n);return`
  ...
  `.trim()}function Ne(e,t){return{BOARD_SIZE_SECTION:De(t),PLAYER_COLOR_SECTION:Oe(t),VISUAL_THEME_SECTION:Q(t),PREVIEW:Me(e,t),FOOTER_THEME:V(ke(e,t)),FOOTER_PLAYER:V(Ae(e,t)),FOOTER_BOARD:V(je(e,t)),TITLE_RULE_IMG:xe}}function Pe(e,t){return U(le,Ne(e,t))}function Fe(){let e=n.view;return e===`home`?ce():e===`settings`?Pe(n.settings,n.settingsDraft):ie(n.game,n.settings,n.showGameOver)}function $(e){k(e,n.settings,n.view),e.innerHTML=Fe(),D(e,()=>$(e))}var Ie=`app`;function Le(){let e=document.getElementById(Ie);e!==null&&$(e)}Le();