(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e={view:`home`,settings:{boardSizeId:`4x4`,visualThemeId:`code-vibes`,layoutId:`nature`,firstPlayerColor:`blue`},game:null,showGameOver:!1},t=[{id:`4x4`,cols:4,rows:4,label:`16 cards`},{id:`4x6`,cols:4,rows:6,label:`24 cards`},{id:`6x6`,cols:6,rows:6,label:`36 cards`}],n=[{id:`code-vibes`,label:`Code vibes theme`,description:`Teal, klarer Dev-Look`},{id:`gaming`,label:`Gaming theme`,description:`Neon-Kanten, dunkle Karten`},{id:`da-projects`,label:`DA Projects theme`,description:`Sachlich, hoher Kontrast`},{id:`foods`,label:`Foods theme`,description:`Warme Töne, einladend`}],r=[{id:`nature`,label:`Natur & Tiere`,description:`Grüntöne, Wald- und Tier-Motive`,cssClass:`layout-nature`,pairs:`🐻.🦊.🐸.🐼.🦁.🐯.🐵.🐰.🦉.🦋.🐢.🦔.🌲.🌿.🍄.🌻.🦆.🐧.🦩.🐝.🍃.🌳.🌺.🪵.🪨.🦫.🐿️.🦌.🐬.🦭.🪷.🌴`.split(`.`)},{id:`space`,label:`Weltraum`,description:`Dunkelblau/Violett, Kosmos-Motive`,cssClass:`layout-space`,pairs:`🚀.🛸.🛰️.🌙.⭐.🌟.🪐.☄️.🌌.👽.🌑.🌠.🔭.🌍.🌕.☀️.🌎.🌖.🌗.🌘.🌒.🌓.🌔.🌚.👾.🤖.💫.✨.⚡.🌩️.📡.🧑‍🚀`.split(`.`)}];function i(e){return e===`blue`?{player1:`blue`,player2:`orange`}:{player1:`orange`,player2:`blue`}}function a(e){let n=t.find(t=>t.id===e);if(!n)throw Error(`Unbekannte Spielfeldgröße: ${e}`);return n}function o(e){let t=r.find(t=>t.id===e);if(!t)throw Error(`Unbekanntes Layout: ${e}`);return t}function s(e){let t=n.find(t=>t.id===e);if(!t)throw Error(`Unbekanntes Theme: ${e}`);return t}function c(e){return e.cols*e.rows/2}function ee(e){let t=[...e];for(let e=t.length-1;e>0;--e){let n=Math.floor(Math.random()*(e+1));[t[e],t[n]]=[t[n],t[e]]}return t}function l(e,t){let n=[],r=0;for(let i=0;i<t;i+=1){let t=e[i];n.push({id:r++,pairId:i,symbol:t}),n.push({id:r++,pairId:i,symbol:t})}return n}function te(e){let t=a(e.boardSizeId),n=o(e.layoutId),r=c(t),i=n.pairs.slice(0,r);if(i.length<r)throw Error(`Nicht genügend Symbole für die gewählte Spielfeldgröße.`);return ee(l(i,r))}var u=class{cards;revealed;matched;scores;currentPlayer;firstSelection=null;secondSelection=null;busy=!1;complete=!1;constructor(e){let t=te(e);this.cards=t,this.revealed=t.map(()=>!1),this.matched=t.map(()=>!1),this.scores=[0,0],this.currentPlayer=0}getSnapshot(){return this.createSnapshot()}createSnapshot(){return{cards:this.cards,revealed:this.revealed,matched:this.matched,scores:this.scores,currentPlayer:this.currentPlayer,firstSelection:this.firstSelection,secondSelection:this.secondSelection,isBusy:this.busy,isComplete:this.complete}}isFaceVisible(e){return this.revealed[e]||this.matched[e]}hasPendingSecondPick(){return this.firstSelection!==null&&this.secondSelection!==null}canSelect(e){return this.busy||this.complete||this.matched[e]||this.hasPendingSecondPick()?!1:this.firstSelection!==e}clearSelection(){this.firstSelection=null,this.secondSelection=null}isPairMatch(e,t){return this.cards[e].pairId===this.cards[t].pairId}switchPlayer(){this.currentPlayer=this.currentPlayer===0?1:0}markPairMatched(e,t){this.matched[e]=!0,this.matched[t]=!0,this.scores[this.currentPlayer]+=1}applyMatch(e,t,n,r){this.markPairMatched(e,t),this.clearSelection(),this.busy=!1,this.matched.every(Boolean)&&(this.complete=!0),n(),this.complete&&r()}applyMismatch(e,t,n){this.revealed[e]=!1,this.revealed[t]=!1,this.clearSelection(),this.switchPlayer(),this.busy=!1,n()}resolveFlip(e,t,n,r){this.isPairMatch(e,t)?this.applyMatch(e,t,n,r):this.applyMismatch(e,t,n)}scheduleFlipResolution(e,t,n,r){window.setTimeout(()=>{this.resolveFlip(e,t,n,r)},700)}openSecondPick(e,t,n){this.secondSelection=e,this.busy=!0,t();let r=this.firstSelection,i=this.secondSelection;r===null||i===null||this.scheduleFlipResolution(r,i,t,n)}selectCard(e,t,n){if(this.canSelect(e)){if(this.revealed[e]=!0,this.firstSelection===null){this.firstSelection=e,t();return}this.openSecondPick(e,t,n)}}};function d(e){let[t,n]=e;return t>n?`player1`:n>t?`player2`:`draw`}function f(e,t){return e.querySelector(`input[name="${t}"]:checked`)?.value??null}function p(t){let n=f(t,`boardSize`);n!==null&&(e.settings.boardSizeId=n)}function m(t){let n=f(t,`playerColor`);n!==null&&(e.settings.firstPlayerColor=n)}function h(t){let n=f(t,`visualTheme`);n!==null&&(e.settings.visualThemeId=n)}function g(e){p(e),m(e),h(e)}function _(e,t,n){e.querySelectorAll(`[data-action="${t}"]`).forEach(e=>{e.addEventListener(`click`,n)})}function ne(t){e.view=`settings`,t()}function v(t){e.view=`home`,t()}function y(t,n){g(t),e.game=new u(e.settings),e.showGameOver=!1,e.view=`game`,n()}function b(t){e.game=null,e.showGameOver=!1,e.view=`settings`,t()}function x(t){e.game=new u(e.settings),e.showGameOver=!1,t()}function S(t,n){let r=t.currentTarget,i=Number(r.dataset.cardIndex),a=e.game;a===null||Number.isNaN(i)||a.selectCard(i,()=>n(),()=>{e.showGameOver=!0,n()})}function C(e,t){e.querySelectorAll(`.memory-card[data-card-index]`).forEach(e=>{e.addEventListener(`click`,e=>S(e,t))})}function w(e,t){let n=e.querySelector(`.screen--settings`);n!==null&&n.querySelectorAll(`input[type="radio"]`).forEach(n=>{n.addEventListener(`change`,()=>{g(e),t()})})}function T(e,t){_(e,`go-settings`,()=>ne(t)),_(e,`go-home`,()=>v(t)),_(e,`start-game`,()=>y(e,t)),_(e,`exit-game`,()=>b(t)),_(e,`new-round`,()=>x(t)),_(e,`go-settings-from-game`,()=>b(t)),C(e,t),w(e,t)}var E=`app-root`;function D(e,t,n){if(e.className=``,e.classList.add(E),e.classList.add(`theme--${t.visualThemeId}`),n===`settings`){e.classList.add(`app-root--settings`);return}e.classList.add(o(t.layoutId).cssClass)}var O=0;function k(e,t,n){return`<div class="game-bar__pair">
          ...
          </span>`}function R(e,t,n){let r=e.isFaceVisible(n),i=t.matched[n],a=r?` is-flipped`:``,o=i?` is-matched`:``,s=I(t,i),c=t.cards[n];return`<button type="button" class="memory-card${a}${o}" data-card-index="${n}" aria-label="Karte ${n+1}" ${s}>${L(c.symbol)}</button>`}function z(e){let t=document.createElement(`div`);return t.textContent=e,t.innerHTML}var B=`<dialog class="modal" open aria-labelledby="game-over-title" aria-modal="true">\r
...
`;function V(e,t){let n=e;for(let[e,r]of Object.entries(t))n=n.replaceAll(`{{${e}}}`,r);return n}function H(e,t,n){return`Spieler 1: <span class="player-tag player-tag--${n.player1}">${e}</span> · Spieler 2: <span class="player-tag player-tag--${n.player2}">${t}</span>`}function U(e){return e===`draw`?`Unentschieden!`:e===`player1`?`Spieler 1 gewinnt!`:`Spieler 2 gewinnt!`}function W(e){return e===`draw`?``:` modal__winner--highlight`}function G(e,t,n){let r=d([e,t]),i=U(r);return V(B,{SCORE_LINE:H(e,t,n),WINNER_MODIFIER:W(r),MESSAGE:z(i)})}var K=`<main class="screen screen--game">\r
...
`;function q(e,t){return`--cols: ${e}; --rows: ${t};`}function J(e,t){return t.cards.map((n,r)=>R(e,t,r)).join(``)}function Y(e,t,n){return t&&e.isComplete?G(e.scores[0],e.scores[1],n):``}function X(e,n,r){let a=e.getSnapshot(),o=i(n.firstPlayerColor),s=t.find(e=>e.id===n.boardSizeId);return s===void 0?``:V(K,{GAME_BAR:F(a,o),GRID_STYLE:q(s.cols,s.rows),CARDS:J(e,a),GAME_OVER:Y(a,r,o)})}function Z(e,t,n){return e===null?``:X(e,t,n)}var re=``+new URL(`Primary button-CNXT5xaq.svg`,import.meta.url).href,ie=`<svg class="screen-home__deco-svg" aria-hidden="true" focusable="false" width="363" height="410" viewBox="0 0 363 410" fill="none" preserveAspectRatio="xMidYMid meet" xmlns="http://www.w3.org/2000/svg">
...
`;function oe(){return V(ae,{PRIMARY_BUTTON_SRC:re,STADIA_CONTROLLER_SVG:ie.trim()})}var se=`<main class="screen screen--settings">\r
...
`,ce=`<section class="panel panel--settings panel--board-size" aria-labelledby="fieldset-board-size-title">
...
`,le=`<section class="panel panel--settings panel--choose-player" aria-labelledby="fieldset-player-color-title">
...
`,ue=`<section class="panel panel--settings panel--game-themes" aria-labelledby="fieldset-visual-theme-title">
...
`,de=``+new URL(`Frame_codeing-vibes-D-m96y1D.svg`,import.meta.url).href,fe=`data:image/svg+xml,%3csvg%20width='263'%20height='24'%20viewBox='0%200%20263%2024'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M-0.000152588%2011.547L11.5469%2023.094L23.0939%2011.547L11.5469%20-8.58307e-06L-0.000152588%2011.547ZM262.547%2011.547V9.547L11.5469%209.547V11.547V13.547L262.547%2013.547V11.547Z'%20fill='%23F0EA6E'/%3e%3c/svg%3e`,pe=`data:image/svg+xml,%3csvg%20width='50'%20height='18'%20viewBox='0%200%2050%2018'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M49.6603%208.66028L41%202.28095e-05L32.3397%208.66028L41%2017.3205L49.6603%208.66028ZM0%208.66028L0%2010.1603L41%2010.1603V8.66028V7.16028L0%207.16028L0%208.66028Z'%20fill='%23F0EA6E'/%3e%3c/svg%3e`,me=``+new URL(`player_blue-B1309wxq.svg`,import.meta.url).href,he=``+new URL(`player_orange-B00NK6Y2.svg`,import.meta.url).href,ge=`data:image/svg+xml,%3csvg%20width='10'%20height='8'%20viewBox='0%200%2010%208'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M1.02564%208C0.74359%208%200.502137%207.90208%200.301282%207.70625C0.100427%207.51042%200%207.275%200%207V1C0%200.725%200.100427%200.489583%200.301282%200.29375C0.502137%200.0979167%200.74359%200%201.02564%200H6.66667C6.82906%200%206.98291%200.0354167%207.12821%200.10625C7.27351%200.177083%207.39316%200.275%207.48718%200.4L9.79487%203.4C9.93162%203.575%2010%203.775%2010%204C10%204.225%209.93162%204.425%209.79487%204.6L7.48718%207.6C7.39316%207.725%207.27351%207.82292%207.12821%207.89375C6.98291%207.96458%206.82906%208%206.66667%208H1.02564Z'%20fill='%232BB1FF'/%3e%3c/svg%3e`,_e=`data:image/svg+xml,%3csvg%20width='10'%20height='8'%20viewBox='0%200%2010%208'%20fill='none'%20xmlns='http://www.w3.org/2000/svg'%3e%3cpath%20d='M1.02564%208C0.74359%208%200.502137%207.90208%200.301282%207.70625C0.100427%207.51042%200%207.275%200%207V1C0%200.725%200.100427%200.489583%200.301282%200.29375C0.502137%200.0979167%200.74359%200%201.02564%200H6.66667C6.82906%200%206.98291%200.0354167%207.12821%200.10625C7.2735%200.177083%207.39316%200.275%207.48718%200.4L9.79487%203.4C9.93162%203.575%2010%203.775%2010%204C10%204.225%209.93162%204.425%209.79487%204.6L7.48718%207.6C7.39316%207.725%207.2735%207.82292%207.12821%207.89375C6.98291%207.96458%206.82906%208%206.66667%208H1.02564Z'%20fill='%23F58E39'/%3e%3c/svg%3e`,ve=`<svg width="11" height="9" viewBox="0 0 11 9" fill="none" xmlns="http://www.w3.org/2000/svg">
<path d="M8.575 5H3C2.85833 5 2.73958 4.95208 2.64375 4.85625C2.54792 4.76042 2.5 4.64167 2.5 4.5C2.5 4.35833 2.54792 4.23958 2.64375 4.14375C2.73958 4.04792 2.85833 4 3 4H8.575L8.15 3.575C8.05 3.475 8.00208 3.35833 8.00625 3.225C8.01042 3.09167 8.05833 2.975 8.15 2.875C8.25 2.775 8.36875 2.72292 8.50625 2.71875C8.64375 2.71458 8.7625 2.7625 8.8625 2.8625L10.15 4.15C10.25 4.25 10.3 4.36667 10.3 4.5C10.3 4.63333 10.25 4.75 10.15 4.85L8.8625 6.1375C8.7625 6.2375 8.64375 6.28542 8.50625 6.28125C8.36875 6.27708 8.25 6.225 8.15 6.125C8.05833 6.025 8.01042 5.90833 8.00625 5.775C8.00208 5.64167 8.05 5.525 8.15 5.425L8.575 5ZM6 2.5V1H1V8H6V6.5C6 6.35833 6.04792 6.23958 6.14375 6.14375C6.23958 6.04792 6.35833 6 6.5 6C6.64167 6 6.76042 6.04792 6.85625 6.14375C6.95208 6.23958 7 6.35833 7 6.5V8C7 8.275 6.90208 8.51042 6.70625 8.70625C6.51042 8.90208 6.275 9 6 9H1C0.725 9 0.489583 8.90208 0.29375 8.70625C0.0979167 8.51042 0 8.275 0 8V1C0 0.725 0.0979167 0.489583 0.29375 0.29375C0.489583 0.0979167 0.725 0 1 0H6C6.275 0 6.51042 0.0979167 6.70625 0.29375C6.90208 0.489583 7 0.725 7 1V2.5C7 2.64167 6.95208 2.76042 6.85625 2.85625C6.76042 2.95208 6.64167 3 6.5 3C6.35833 3 6.23958 2.95208 6.14375 2.85625C6.04792 2.76042 6 2.64167 6 2.5Z" fill="white"/>
</svg>
`;function ye(e,t){let n=e.boardSizeId===t.id?`checked`:``;return`
      <li>
        <label class="choice choice--board-size">
          <input class="choice__radio choice__radio--theme" type="radio" name="boardSize" value="${t.id}" ${n} />
          <span class="choice__title choice__title--board">${z(t.label)}</span>
        </label>
      </li>
    `}function be(e){return t.map(t=>ye(e,t)).join(``)}function xe(e,t){return`
      <li>
    ...
    `}function Se(e){return[`blue`,`orange`].map(t=>xe(e,t)).join(``)}function Ce(e,t){let n=e.visualThemeId===t.id?`checked`:``;return`
      <li>
        <label class="choice choice--game-theme">
          ...
          <span class="choice__theme-body">
            <span class="choice__title choice__title--theme">${z(t.label)}</span>
            <span class="choice__theme-accent" aria-hidden="true">
              <img class="choice__theme-accent-img" src="${pe}" width="41" height="18" alt="" decoding="async" />
            </span>
          </span>
        </label>
      </li>
    `}function we(e){return n.map(t=>Ce(e,t)).join(``)}function Te(e){return V(ce,{RADIOS:be(e)})}function Ee(e){return V(le,{RADIOS:Se(e)})}function De(e){return V(ue,{RADIOS:we(e)})}function Oe(e){return s(e.visualThemeId).label}function Q(e){return e.firstPlayerColor===`blue`?`Blue`:`Orange`}function ke(e){return a(e.boardSizeId).label}function Ae(e){return`
          ...
          <div class="settings-preview__topbar-inner">
            <div class="settings-preview__topbar-left">
              <span class="settings-preview__player-chip settings-preview__player-chip--blue">
                <img class="settings-preview__player-icon" src="${me}" width="30" height="10" alt="" />
              ...
              <span class="settings-preview__player-chip settings-preview__player-chip--orange">
                <img class="settings-preview__player-icon" src="${he}" width="30" height="10" alt="" />
                <span class="settings-preview__player-count">0</span>
              </span>
            </div>
            ...
            <div class="settings-preview__current-player">
              ...
              <img
                ...
                src="${e.firstPlayerColor===`blue`?ge:_e}"
                width="10"
                height="8"
                alt=""
              />
            ...
            <button type="button" class="settings-preview__exit-btn">
              <span class="settings-preview__exit-icon" aria-hidden="true">${ve.trim()}</span>
  ...
  `.trim()}function je(e){return{BOARD_SIZE_SECTION:Te(e),PLAYER_COLOR_SECTION:Ee(e),VISUAL_THEME_SECTION:De(e),PREVIEW:Ae(e),FOOTER_THEME:z(Oe(e)),FOOTER_PLAYER:z(Q(e)),FOOTER_BOARD:z(ke(e)),TITLE_RULE_IMG:fe}}function Me(e){return V(se,je(e))}function Ne(){let t=e.view;return t===`home`?oe():t===`settings`?Me(e.settings):Z(e.game,e.settings,e.showGameOver)}function $(t){D(t,e.settings,e.view),t.innerHTML=Ne(),T(t,()=>$(t))}var Pe=`app`;function Fe(){let e=document.getElementById(Pe);e!==null&&$(e)}Fe();